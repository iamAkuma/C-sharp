...
// // Custom class representing a number
// class Number
// {
...
//         Number nu1 = new Number(5);
//         Number nu2 = new Number(10);

//         // Add the numbers using the overloaded + operator
//         Number result = nu1 + nu2;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Call the MakeSound method on the base class instance
        // The implementation of MakeSound will be determined at runtime
        animal.MakeSound(); // Output: Animal makes a sound

        // Call the MakeSound method on the derived class instance
        // The overridden implementation of MakeSound in Dog will be called
        dog.MakeSound(); // Output: Dog barks

        // Demonstrate dynamic binding with a base class reference
        Animal dynamicAnimal = new Dog(); // Creating a Dog object but referencing it as an Animal
